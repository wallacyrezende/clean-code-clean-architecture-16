package cleancodecleanarchitecture16.account.application.exceptions.handler;

import cleancodecleanarchitecture16.account.application.exceptions.BusinessException;
import cleancodecleanarchitecture16.account.application.exceptions.NotFoundException;
